...
**Converted ADUs and JADUs** (constructed from existing space) shall **not** be considered a new residential use for purposes of calculating connection fees or capacity charges for utilities, including water and sewer services. (Gov. Code, § 66324, subd. (b).)

**Exception:** This does not apply to ADUs constructed concurrently with a new single-family dwelling. (Gov. Code, § 66324, subd. (d).)

**All ADUs:** Connection fees or capacity charges must be **proportionate** to the burden of the proposed ADU, based on its square footage or plumbing fixtures as compared to the primary dwelling. (Gov. Code, § 66324, subd. (e).)
...
### Deed Restrictions and Fees

A local agency **cannot impose a deed restriction** on an ADU. Gov. Code § 66315 establishes that no additional standards beyond those in § 66314 shall be imposed. A deed restriction is not a design or development standard. (Gov. Code, § 66315.)

**JADUs** are different — a local agency **may require** recordation of a deed restriction that includes a prohibition on separate sale and a restriction on size/attributes conforming with state law. (Gov. Code, § 66333, subds. (c)(1), (c)(2).)

### Cross-References
- See also: `permit-process.md` — Permit application timeline and processing fees
- See also: `permit-funding.md` — Financial assistance and loan programs for ADUs
- See also: `standards-size.md` — Size thresholds relevant to fee calculations
- See also: `unit-types-jadu.md` — JADU deed restriction requirements
- See also: `compliance-utilities.md` — Utility connection details and CPUC complaints
...
- Gov. Code § 66477 — Quimby Act (park dedication fees)
- Education Code § 17620 — School district authority to levy impact fees
